...
public class ShapeManager {
    ...
    public void printAllShapes() {
        ...
        for(int i =0; i<index; i++){
            System.out.println("Shape: " + shapes[i].getClass().getName());
            System.out.println("calculateArea: " + shapes[i].calculateArea());
            System.out.println("calculatePerimeter: " + shapes[i].calculatePerimeter());
        }
    }
